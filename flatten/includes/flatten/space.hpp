...
#define FLATTEN_SWITCH(STATE, VALUE) switch (_size) {   \
    ...
    public:
        static bool comp(const space_t &space0, const space_t &space1)
        {   return space0.base() < space1.base(); }
        static bool mcomp(const space_t &space0, const space_t &space1)
        {   return space0.mbase() < space1.mbase(); }
